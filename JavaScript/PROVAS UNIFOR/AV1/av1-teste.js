...
let paisOrigem = prompt('Digite aqui o país de origem desse produto:\n\n1 - Estados Unidos\n2 - México\n3 - Outros');
...
if (cargaPerigosa == 'S') {
      ...
      document.write(`país escolhido: ${paisOrigem}<br>`);
}
...
if (paisOrigem != 2 || transporte == 'A') {
      seguro = i / 2;
      document.write(`O país escolhido não é o México ou o transporte escolhido não é Aéreo<br>`);
}
else {
      seguro = valorTransporte * 2;
      document.write(`O contrário da primeira condiçãobr<br>`);
}
document.write(`O valor do seguro é de: R$ ${seguro}<br><br>`);
